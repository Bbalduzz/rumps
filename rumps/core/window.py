# -*- coding: utf-8 -*-
"""
window.py — Window and Response classes for rumps-style macOS status bar apps.
"""
...
from ..utils.text_field import Editing, SecureEditing
from ..utils.compat import text_type, string_types
from ..utils import internal as _internal
from ..utils.helpers import nsimage_from_file as _nsimage_from_file
...
class Window(object):
    ...
    def run(self):
        ...
        _log = getattr(__import__('rumps').utils.helpers, '_log', lambda *a, **k: None)  # optional
        _log(self)
...
class Response(object):
    ...
    def clicked(self):
        ...
        Additional buttons added using :meth:`rumps.Window.add_button` and :meth:`rumps.Window.add_buttons`
