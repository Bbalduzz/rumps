...
# Import events and notifications modules
from . import events
...
# Import debug_mode and _log from the refactored helpers module
from .utils.helpers import debug_mode, _log
debug_mode(False)  # Initialize with debugging off
...
# Import _nsimage_from_file from the refactored helpers module
